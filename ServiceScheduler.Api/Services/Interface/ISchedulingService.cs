...
public interface ISchedulingService
{
    ...
    Task<(bool Success, string Error)> TransitionAppointmentAsync(int appointmentId, AppointmentStatus toStatus, string changedBy, string reason, CancellationToken ct = default);
